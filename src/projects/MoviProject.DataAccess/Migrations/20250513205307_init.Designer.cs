            ...
            modelBuilder.Entity("MoviProject.Model.Entities.Artist", b =>
                {
                    ...
                    b.ToTable("Artist_db", (string)null);
                });
            ...
            modelBuilder.Entity("MoviProject.Model.Entities.Category", b =>
                {
                    ...
                    b.ToTable("Categories_db", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedTime = new DateTime(2025, 5, 13, 20, 53, 7, 511, DateTimeKind.Utc).AddTicks(5377),
                            Name = "korku"
                        },
                        new
                        {
                            Id = 2,
                            CreatedTime = new DateTime(2025, 5, 13, 20, 53, 7, 511, DateTimeKind.Utc).AddTicks(5378),
                            Name = "dram"
                        });
                });
            ...
            modelBuilder.Entity("MoviProject.Model.Entities.Director", b =>
                {
                    ...
                    b.ToTable("Director_db", (string)null);

                    b.HasData(
                        new
                        {
                            Id = 1L,
                            BirthDay = new DateTime(1959, 2, 9, 16, 39, 25, 0, DateTimeKind.Unspecified),
                            CreatedTime = new DateTime(2025, 5, 13, 20, 53, 7, 511, DateTimeKind.Utc).AddTicks(8115),
            ...
            modelBuilder.Entity("MoviProject.Model.Entities.Movie", b =>
                {
                    ...
                    b.ToTable("Movies_db", (string)null);
                });
            ...
            modelBuilder.Entity("MoviProject.Model.Entities.MovieArtist", b =>
                {
                    ...
                    b.ToTable("MovieArtist_db", (string)null);
                });
